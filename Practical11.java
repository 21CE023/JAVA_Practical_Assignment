...
class Practical11 { 
    public static void main(String[] args) throws ExecutionException { 
        Triplet<String, Integer, Character> p1 = Triplet.of("JYOT DELVADIYA", 18, 'M'); 
        Triplet<String, Integer, Character> p2 = Triplet.of("KUSH", 19, 'M'); 
        Triplet<String, Integer, Character> p3 = Triplet.of("LUV", 19, 'M'); 
